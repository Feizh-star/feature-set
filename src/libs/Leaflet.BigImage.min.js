...
!(function (t, e) {
  ...
  ;(t.Control.BigImage = t.Control.extend({
    ...
    _createControl: function (t, e, i, n, o) {
      ...
      return (
        (s.style.width = '100%'),
        (s.innerHTML = this.options.inputTitle),
        this._containerParams.appendChild(s),
        this._createScaleInput(),
        this._createDownloadButton(),
        this._container.appendChild(this._containerParams),
        this._createControlPanel(i, o, t, e, n),
        this._container
      )
    },
        ...
        new Promise(function (e, i) {
          ...
          .then(() => {
            t.canvas.toBlob(function (t) {
              ...
              ;(e.download = 'my-image.png'), (e.href = URL.createObjectURL(t)), e.click()
            }),
